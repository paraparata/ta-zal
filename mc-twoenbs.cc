      ...
      if (dl)
        {
          ...
          dlClient.SetAttribute ("MaxBytes", UintegerValue (0xFFFFFFFF));
      ...
      if (ul)
        {
          ...
          BulkSendHelper ulClient ("ns3::TcpSocketFactory",
		                         InetSocketAddress (remoteHostAddr, ulPort));
          // ulClient.SetAttribute ("Interval", TimeValue (MicroSeconds (interPacketInterval)));
          ulClient.SetAttribute ("MaxBytes", UintegerValue (0xFFFFFFFF));
